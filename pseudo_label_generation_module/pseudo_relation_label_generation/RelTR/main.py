...
def get_args_parser():
    ...
    parser.add_argument('--ann_path', default='/hdd/lhxiao/RelTR/vg/', type=str)
    # parser.add_argument('--img_folder', default='/home/cong/Dokumente/tmp/data/visualgenome/images/', type=str)
    parser.add_argument('--img_folder', default='/hdd/lhxiao/RelTR/VG_100K_all/', type=str)

    parser.add_argument('--output_dir', default='/hdd/lhxiao/RelTR/output/',
