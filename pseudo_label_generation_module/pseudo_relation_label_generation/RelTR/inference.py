...
def get_args_parser():
    ...
    # parser.add_argument('--img_path', type=str, default='demo/vg3.jpg', help="Path of the test image")
...
def main(args):
    ...
    with torch.no_grad():
        ...
        h, w = conv_features['0'].tensors.shape[-2:]  # h 34， w 25
        im_w, im_h = im.size  # 500 375

        fig, axs = plt.subplots(ncols=len(indices), nrows=3, figsize=(22, 7))  # fig：2200*700, axs：3*10
